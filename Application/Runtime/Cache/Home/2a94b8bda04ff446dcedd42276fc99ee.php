...
<div class="container-fluid noPadding">
	<img src="/register/Public/Home/images/1.jpg" alt="" class="img-responsive" alt="Responsive image" style="margin-top: -20px;">
	<div class="introduce" style="padding:0 10px;">
		<?php echo ($intro["cont"]); ?>
	</div>
	<video autoplay="autoplay" src="/register/Public/Home/images/video.mp4" controls="controls">
		您的浏览器不支持 video 标签。
	</video>
