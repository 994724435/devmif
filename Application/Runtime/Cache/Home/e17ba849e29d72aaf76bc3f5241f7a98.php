        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="side-menu">
                <ul class="nav navbar-nav" id="side-item">
                    ...
                    <li><a href="advertising.html">公司公告</a></li>
                    <li><a href="K.html">同步k线图</a></li>
                    <li><a href="gruop.html">值班团队</a></li>
                    <li><a href="professor.html">分析专家</a></li>
                    <li><a href="/index.php/Home/User/my.html">个人中心</a></li>
                    <li><a href="gongPai.html">MIF公排</a></li>
                    <li><a href="share.html">MIF分享</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container-fluid noPadding">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
             http://echarts.baidu.com/echarts2/doc/example/k.html
          </div>
         </div>
         <div class="panel panel-default">
          <div class="panel-heading">推广二维码</div>
          <div class="panel-body">
                <img src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1530102068,1742058941&fm=26&gp=0.jpg" alt="" class="codeiMG">
