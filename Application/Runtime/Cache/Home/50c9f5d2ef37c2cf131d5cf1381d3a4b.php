...
<head>
	...
	<link rel="stylesheet" href="/register/Public/Home/css/amazeui.min.css">
	<link rel="stylesheet" href="/register/Public/Home/css/app.css">
</head>
<body>
<div class="am-g myapp-login">
	<div class="myapp-login-bg">
		<div class="myapp-login-logo">
			<img src="/register/Public/Home/images/logo.gif" alt="" class="logoI">
		</div>
