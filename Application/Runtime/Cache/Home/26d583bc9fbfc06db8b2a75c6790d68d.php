...
<link type="text/css" rel="stylesheet" href="/register/Public/Home/css/basic.css" />
...
// 发送短信
  $("#getTelCode").click(function() {
       ...
       $.ajax({
         type: "POST",
         url: "/register/index.php/Home/Login/sendTel",
          dataType: "json",
         data: {
             'tel': tel
         },
  ...
  $("#geteamilCode").click(function() {
       ...
       $.ajax({
         type: "POST",
         url: "/register/index.php/Home/Login/sendEmail",
          dataType: "json",
         data: {
            'email': eamil
         },
