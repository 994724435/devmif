  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">类别</label>
									<div class="col-sm-8">
										<select class="form-control1" name="type">
											<option value="<?php echo ($res["type"]); ?>"><?php if($res["type"] == 1): ?>网站首页<?php elseif($res["type"] == 2): ?>公司简介<?php elseif($res["type"] == 3): ?>值班团队<?php elseif($res["type"] == 4): ?>分析专家<?php endif; ?></option>
